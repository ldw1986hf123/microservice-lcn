package com.ldw.metadata.constant;
...
public class CommonConstants {
	...
	/**
	 * @desc oracle 字段是否是主键属性值集合
	 * 
	 * @author WangXf
	 * @date 2020年9月23日 上午10:23:14
	 */
	public class OracleIsPrimaryKey {
	...
	/**
	 * @desc elasticsearch 索引
	 * 
	 * @author WangXf
	 * @date 2020年9月25日 下午3:43:36
	 */
	public class ESIndex {
		public static final String TABLE_METADATA_INDEX = "table_metadata_index";
		public static final String COLUMN_METADATA_INDEX = "column_metadata_index";
		public static final String TABLE_METADATA_HISTORY_RECORD_INDEX = "table_metadata_history_record_index";
		public static final String INDEX_METADATA_INDEX = "index_metadata_index";
		public static final String PARTITION_METADATA_INDEX = "partition_metadata_index";
		public static final String TASK_INFO_INDEX = "task_info_index";
		public static final String TASK_LOG_INDEX = "task_log_index";
		public static final String TASK_METADATA_COLLECTION_INDEX = "task_metadata_collection_index";

		public static final String USER_COLLECTION_INDEX = "user_collection_index";
		public static final String USER_BROWSER_INDEX = "user_browser_index";

//		public static final String USER_RECENT_BROWSER_INDEX = "recent_browser_index";
	}
	...
	public enum ResponseCodeTask {
		FAIL("fail", "执行失败"), SUCCESS("success", "执行成功"), NOT_FOUND_TASK("not_found_task", "任务不存在"),
		INVALID_TASK("invalid_task", "无效任务"), TASK_IS_RUNNING("task_is_running", "任务正在运行中"),
	 ...
	 * 
	 * @author WangXf
	 * @date 2020年11月6日 下午3:02:53
	 */
	public class AlterationApiImpl {

		public static final String HIVE = "com.deepexi.daas.metadata.common.impl.HiveTableAlterationApiImpl";
		public static final String ORACLE = "com.deepexi.daas.metadata.common.impl.OracleTableAlterationApiImpl";
		public static final String MYSQL = "com.deepexi.daas.metadata.common.impl.MySQLTableAlterationApiImpl";
		public static final String SQLSERVER = "com.deepexi.daas.metadata.common.impl.SqlServerTableAlterationApiImpl";
	 ...
	 * 
	 * @author WangXf
	 * @date 2020年11月20日 下午3:07:58
	 */
	public class DataSourceInstanceBuilderClass {
		public static final String JDBC = "com.deepexi.daas.metadata.scheduler.api.impl.JdbcDataSourceBuilder";
		public static final String KUDU = "com.deepexi.daas.metadata.scheduler.api.impl.KuduDataSourceBuilder";
	}
	 ...
	 * 
	 * @author WangXf
	 * @date 2020年11月20日 下午3:13:27
	 */
	public class AutoCollectorMetadataInstanceClass {
		public static final String HIVE = "com.deepexi.daas.metadata.autoCollector.collector.AutoCollectorMetadataHiveJdbc";
		public static final String IMPALA = "com.deepexi.daas.metadata.autoCollector.collector.AutoCollectorMetadataImpalaJdbc";
		public static final String ORACLE = "com.deepexi.daas.metadata.autoCollector.collector.AutoCollectorMetadataOracleJdbc";
		public static final String KUDU = "com.deepexi.daas.metadata.autoCollector.collector.AutoCollectorMetadataKudu";

		public static final String MYSQL = "com.deepexi.daas.metadata.autoCollector.collector.AutoCollectorMetadataMySql";
		public static final String SQLSERVER = "com.deepexi.daas.metadata.autoCollector.collector.AutoCollectorMetadataSqlServer";
	}
	 ...
	 */
	public class TableMetadataHistoryRecordsStatus {
