...
class Main {
    ...
    public static String myEmailAccount = "ludanwen@ldwgc.onexmail.com";
    public static String myEmailPassword = "19861020123abcABC";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        List<String> receiceMailList=new ArrayList<>();
        receiceMailList.add("ldw1986hf123@163.com");
...
/*        sendTo[0]= new InternetAddress("118001489@qq.com");
        ...
        message.setContent("您关注的  元数据发送变化", "text/html;charset=UTF-8");
