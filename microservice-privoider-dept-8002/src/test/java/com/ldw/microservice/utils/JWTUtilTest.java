...
public  class JWTUtilTest {
    ...
    public void generateToken() {
        String token = JWTUtil.generateToken("ldw");
        System.out.println(token);
    }
    @Test
    public void verify() {
        System.out.println( JWTUtil.verify("eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJpc3N1ZXIiLCJleHAiOjE1ODQ5ODYzMjEsImlhdCI6MTU4NDk4NjI2MSwidXNlcm5hbWUiOiJsZHcifQ.3HmSpXuAR_gc-FP9IdLtJBpUMAyfmt8CZg5D7iNBuSM"));
    }
