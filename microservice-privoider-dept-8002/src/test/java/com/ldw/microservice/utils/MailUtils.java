    ...
    public void senMail() throws Exception {
        ...
        Authenticator authenticator = new Authenticator() {
            ...
            public PasswordAuthentication getPasswordAuthentication() {
                ...
                return new PasswordAuthentication("ldw1986hf123@163.com", "aaaaa888");
            }
        };
        ...
        message.setFrom(new InternetAddress("ldw1986hf123@163.com"));
        /**
         * 2.2 收件人
         *         第一个参数：
         ...
         *         这里我们发送给我们的qq邮箱
         */
        message.setRecipient(RecipientType.TO, new InternetAddress("314445417@qq.com"));
        // 2.3 主题（标题）
